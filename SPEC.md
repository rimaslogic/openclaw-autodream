...
## People & Relationships
- **Rimas** - Head of Engineering at Cloudvisor, values precision...
- **Julio Perez** - Team Lead test run (Jan-Mar 2026), passed evaluation...

## Projects & Work
- **Cloudvisor** - Engineering team, pre-sales pipeline management...
- **Rimas Logic** - Personal brand/consulting, newsletter "The AI Logic"...
...
- Supabase + Vercel for Mentalway project (decided 2026-03-18)
